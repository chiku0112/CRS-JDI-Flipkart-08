...
public class CRSApplication {
	...
	{
		System.out.println("----------JDI 08 Course Management System---------");
	...
	public void loginUser()
	{
		...
		try
		{
			...
			//	System.out.println("inside main class - login user");
				System.out.println(" ");
				System.out.println("+++ Welcome to "+ role+ " dashboard ++++");
				System.out.println(" ");
				...
				case PROFESSOR:
					...
					break;
				case STUDENT:
					//System.out.println("inside student role check 1");
					int studentId=studentInterface.getStudentId(userId);
				//	System.out.println("inside student role check 2");
