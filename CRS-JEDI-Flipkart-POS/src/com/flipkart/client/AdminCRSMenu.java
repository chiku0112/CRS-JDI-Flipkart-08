...
public class AdminCRSMenu {
	...
	public void createMenu(){
		...
		while(CRSApplication.loggedin) {
			...
			System.out.println("4. Boolean Approve Students");
			System.out.println("5. View Pending Admission");
			System.out.println("6. Add a Professor");
	...
	private List<Student> viewPendingAdmissions() {
		...
		for(Student student : pendingStudentsList) {
			...
			System.out.println(String.format("%20s | %20d | %20s | %20s", student.getUserId(), StudentDaoOperation.getInstance().getStudentId2(student.getUserId()), student.getName(), student.getGender().toString()));
		}
		return pendingStudentsList;
	}
