...
public class ProfessorOperation implements ProfessorInterface {
	 ...
	 */
	@Override
	public boolean addGrade(int userId,String courseCode,String grade) throws GradeNotAddedException {
		try
		{
			professorDAOInterface.addGrade(userId, courseCode, grade);
		}
		catch(Exception ex)
		{
			throw new GradeNotAddedException(userId);
		}
		return true;
	}
