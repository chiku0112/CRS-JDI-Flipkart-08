...
public class RegistrationDaoOperation implements RegistrationDaoInterface{
	 ...
	 */
	@Override
	public boolean addCourse(String courseCode, int userId) throws SQLException{
		...
		try 
		{
			System.out.println(userId + " Sdkahsj,df aksf bdsa");
			stmt = conn.prepareStatement(SQLQueriesConstants.ADD_COURSE);
			stmt.setString(1, "519");
	...
	public List<Course> viewCourses(int studentId) throws SQLException {
		...
		try 
		{
			...
			//System.out.println("inside registration dao operation -- view courses 1");
			stmt.setInt(1, studentId);
			//stmt.setBoolean(2, true);
		//	System.out.println("inside registration dao operation -- view courses 2");
			ResultSet rs = stmt.executeQuery();
		//	System.out.println("inside registration dao operation -- view courses 3");
			while (rs.next()) {
			...
			//	System.out.println(rs.getString("professorId") + " ~```~~~~`````");
			}
		} 
		catch (SQLException e) 
		{
