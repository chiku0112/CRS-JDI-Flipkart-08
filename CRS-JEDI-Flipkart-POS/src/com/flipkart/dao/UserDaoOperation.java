...
public class UserDaoOperation implements UserDaoInterface{
	...
	public boolean verifyCredentials(String userId, String password) throws UserNotFoundException {
		Connection connection = DBUtils.getConnection();
		//System.out.println("inside userdaooperation");
		try
		{
			//open db connection
	...
	public String getRole(String userId) {
		//System.out.println("inside userinterface get role");
		Connection connection=DBUtils.getConnection();
		try {
			PreparedStatement statement = connection.prepareStatement(SQLQueriesConstants.GET_ROLE);
			statement.setString(1, userId);
			ResultSet rs = statement.executeQuery();
			//System.out.println("inside userinterface get role 2");
			if(rs.next())
			{
				//System.out.println("inside userinterface get role 3 ");
		...
		System.out.println("inside userinterface get role 44");
		return null;
	}
